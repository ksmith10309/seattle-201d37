...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var msg1 = a + ' and ' + b + ' and ' + c + ' sum to ' + totalSum + '.';
  var msg2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + totalProduct + '.';
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var msg = sumArr.join() + ' was passed in as an array of numbers, and ' + totalSum + ' is their sum.';
  return [totalSum, msg];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var msg = 'The numbers ' + multArr.join() + ' have a product of ' + totalProduct + '.';
  return [totalProduct, msg];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  var msg = 'The numbers ' + dynamicArray.join() + ' have a product of ' + product + '.';
  return [product, msg];
}
